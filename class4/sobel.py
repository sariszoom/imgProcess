...
img = cv.imread('class4/img/catonnote.jpg', cv.IMREAD_GRAYSCALE)
...
cv.imwrite('class4/laplacian.png', laplacian)
cv.imwrite('class4/sobelx.png', sobelx)
cv.imwrite('class4/sobely.png',sobely)
